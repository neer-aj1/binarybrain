...
if(isset($_POST['name'])){
    ...
    $sql = "INSERT INTO `weedb`.`weetb` (`registration`, `username`, `full_name`, `email`, `phonenum`, `password`, 'confirmpass', 'category', 'gender') VALUES ('$registration', '$username', '$full_name', '$email', '$phonenum', '$confirmpass','$category', '$gender');";
    // echo $sql;
            ...
            <form action="#">
                <div class="user-details">
                    <div class="input-box">
                        ...
                        <input class="inp-box" type="text" placeholder="Enter your name" required="full_name" />
                    </div>
                    <div class="input-box">
                ...
                <div class="full_name-details">
                    <input type="radio" name="full_name" id="dot-1" value="m" />
                    <input type="radio" name="full_name" id="dot-2" value="f" />
                    <input type="radio" name="full_name" id="dot-3" value="n " />
                    <span class="full_name-title">Gender</span>
                    <div class="category">
                        <label for="dot-1">
                            <span class="dot one"></span>
                            <span class="full_name">Male</span>
                        </label>
                        <label for="dot-2">
                            <span class="dot two"></span>
                            <span class="full_name">Female</span>
                        </label>
                        <label for="dot-3">
                            <span class="dot three"></span>
                            <span class="full_name">Prefer not to say</span>
                        </label>
                    </div>
                </div>
                <div class="button">
